...
public class MonitorView extends JFrame {
    ...
    public void updatePantalla(SocketDataSendModel paqueteRecibido) {
        System.out.println("SocketDataSendModel: " + paqueteRecibido.toString());
        String nroOrden = paqueteRecibido.getNroOrden().toString();
        String letra1 = paqueteRecibido.getLetra1().trim();
        String letra2 = paqueteRecibido.getLetra2().trim();
        String letra3 = paqueteRecibido.getLetra3();
        String nroTerminal = paqueteRecibido.getNroTerminal().toString();
        String descripcionDependencia = paqueteRecibido.getDescripcionDependencia().trim();
    ...
    private void initComponents() {
        ...
        jPanel4.setBackground(new Color(10, 106, 41));
        ...
        TextArea2.setBackground(new Color(10, 106, 41));
        ...
        TextArea2.setBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED, null, new Color(204, 204, 204)));
        TextArea2.setMinimumSize(new java.awt.Dimension(0, 150));

        jPanel2.setBackground(new Color(0, 0, 0));
        jPanel2.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(255, 255, 255)));

        TextArea3.setBackground(new Color(0, 0, 0));
        TextArea3.setColumns(20);
        TextArea3.setFont(new java.awt.Font("Arial", 1, 36)); // NOI18N
        TextArea3.setForeground(new Color(102, 255, 0));
        TextArea3.setRows(1);
        ...
        TextArea6.setForeground(new Color(102, 255, 0));
        TextArea6.setRows(1);
        ...
        TextArea5.setForeground(new Color(102, 255, 0));
        TextArea5.setRows(1);
